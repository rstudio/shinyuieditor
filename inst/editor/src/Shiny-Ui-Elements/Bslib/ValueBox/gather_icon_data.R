...
withr::with_tempdir({
  ...
  new_icon_info <<- list(
    name = icon_names,
    contents = vapply(contents, function(x) paste(as.character(x), collapse = "\n"), character(1))
  )
})
...
# missing_icons <- setdiff(new_icon_info$name, icon_info$name)
...
#   "icon_info <- ",
#   paste(capture.output(dput(icon_info)), collapse = ""),
#   sep = "",
